<?php /* Smarty version Smarty-3.1.21, created on 2018-07-13 16:19:20
         compiled from "D:\xampp\htdocs\cscart\design\backend\templates\views\products\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:53495b48a6d88c88e8-78687216%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '28e35361da889ef69efcdb6fc3ba7ef48a4a291a' => 
    array (
      0 => 'D:\\xampp\\htdocs\\cscart\\design\\backend\\templates\\views\\products\\manage.tpl',
      1 => 1531112124,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '53495b48a6d88c88e8-78687216',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b48a6d977a9a9_54037834',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b48a6d977a9a9_54037834')) {function content_5b48a6d977a9a9_54037834($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'D:/xampp/htdocs/cscart/app/functions/smarty_plugins\\block.hook.php';
...
?><?php
fn_preload_lang_vars(array('position_short','image','name','sku','price','list_price','purchased_qty','subtotal_sum','quantity','status','name','price','list_price','purchased_qty','subtotal_sum','quantity','edit','edit','delete','status','no_data','text_select_fields2edit_note','modify_selected','global_update','bulk_product_addition','product_subscriptions','edit_selected','clone_selected','export_selected','add_product','select_fields_to_edit','products'));
?>
...
echo $_smarty_tpl->tpl_vars['c_dummy']->value;
        ...
        <th class="mobile-hide" width="15%"><a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=list_price&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'UTF-8');?>
" data-ca-target-id=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rev']->value, ENT_QUOTES, 'UTF-8');?>
...
" class="input-mini input-hidden"/>
        ...
        <td  class="mobile-hide" data-th="<?php echo $_smarty_tpl->__("list_price");?>
">
            <input type="text" name="products_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'UTF-8');?>
...
" class="input-mini input-hidden" /></td>
        <?php if ($_smarty_tpl->tpl_vars['search']->value['order_ids']) {?>
        <td data-th="<?php echo $_smarty_tpl->__("purchased_qty");?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['purchased_qty'], ENT_QUOTES, 'UTF-8');?>
</td>
        <td data-th="<?php echo $_smarty_tpl->__("subtotal_sum");?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
    <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
		...
		<?php if ($_smarty_tpl->tpl_vars['products']->value) {?>
            <li class="divider "></li>
            <li class=""><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"dialog",'class'=>"cm-process-items",'text'=>$_smarty_tpl->__("edit_selected"),'target_id'=>"content_select_fields_to_edit",'form'=>"manage_products_form"));?>
</li>
            <li class=""><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>$_smarty_tpl->__("clone_selected"),'dispatch'=>"dispatch[products.m_clone]",'form'=>"manage_products_form"));?>
</li>
            <li class=""><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>$_smarty_tpl->__("export_selected"),'dispatch'=>"dispatch[products.export_range]",'form'=>"manage_products_form"));?>
</li>
            <li class=""><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"delete_selected",'dispatch'=>"dispatch[products.m_delete]",'form'=>"manage_products_form"));?>
</li>
        <?php }?>
