...
<script type="text/javascript"  class="cm-ajax-force">
    ...
    (function(_, $) {
        ...
        {
            var check_country = $("#{$prefix}elm_country{$id_suffix}").length ? $("#{$prefix}elm_country{$id_suffix}").val() : '';
            var check_state = $("#{$prefix}elm_state{$id_suffix}").length ? $("#{$prefix}elm_state{$id_suffix}").val() : '';
